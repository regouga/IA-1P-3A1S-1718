...
def compare_searchers(problems, header,searchers=[depth_first_graph_search,best_first_graph_search,astar_search]):
    def do(searcher, problem):
        p = InstrumentedProblem(problem)
        if searcher == depth_first_graph_search: 
            searcher(p)
        else:
            searcher(p,p.h)
        return p
...
def compare_graph_searchers():
    ...
    compare_searchers(problems=[same_game([[1,2,1,2,1],[2,1,2,1,2],[1,2,1,2,1],[2,1,2,1,2]]),
                                same_game([[1,2,2,3,3],[2,2,2,1,3],[1,2,2,2,2],[1,1,1,1,1]]),
                                same_game([[3,1,3,2],[1,1,1,3],[1,3,2,1],[1,1,3,3],[3,3,1,2],[2,2,2,2],[3,1,2,3],[2,3,2,3],[5,1,1,3],[4,5,1,2]]),
                                same_game([[3,1,3,2],[1,1,1,3],[1,3,2,1],[1,1,3,3],[3,3,1,2],[2,2,2,2],[3,1,2,3],[2,3,2,3],[2,1,1,3],[2,3,1,2]]),
                                same_game([[1,1,5,3],[5,3,5,3],[1,2,5,4],[5,2,1,4],[5,3,5,1],[5,3,4,4],[5,5,2,5],[1,1,3,1],[1,2,1,3],[3,3,5,5]])],
